...
var ajaxifyShopify = (function(module, $) {
  ...
  flipSetup = function () {
    ...
    var checkoutBtn = $('<a href="/cart" class="flip__back" style="background-color: #C00; color: #fff;" class="flip__checkout">"Check Out" </a>').addClass($btnClass),
        ...
        flipExtra = $('<div class="flip__extra"><a href="#" class="flip__cart">"View Bag" (<span></span>)</a></div>');
  ...
  modalSetup = function () {
    ...
    $modalContainer.prepend('<button type="button" class="ajaxcart__close" title="' + "Close Bag" + '">' + "Close Bag" + '</button>');
  ...
  buildCart = function (cart) {
    ...
    if (cart.item_count === 0) {
      $cartContainer
        .append('<h3 class="uppercase h3">' + "Your bag is empty." + '</h3>')
    ...
    $cartContainer.load(url, function() {
      ...
      switch (settings.method) {
        ...
        case 'drawer':
          ...
          $cartContainer.prepend('<button type="button" class="ajaxcart__close" title="' + "Close Bag" + '">' + "Close Bag" + '</button>');
          $closeCart = $('.ajaxcart__close');
